...
3.  An easy way to run the scripts is by setting your working directory to the directory that includes the Raw Data Folded.  Then copy paste into R the following....
