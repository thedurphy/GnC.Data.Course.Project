...
3.  An easy way to run the scripts is by setting your working directory to the directory that includes the Raw Data Folder.  Then copy paste into R the following....
